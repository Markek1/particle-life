...
pub static MAX_DISTNACE: f32 = 250.; // Distance at which particles stop having an effect on each other
pub static REPEL_CONSTANT: f32 = 0.5;
pub static ATTRACTION_CONSTANT: f32 = 0.005;
pub static NUM_PARTICLES: usize = 800;
pub static PARTICLE_RADIUS: f32 = 3.;
pub static PARTICLE_FRICTION: f32 = 0.05;
