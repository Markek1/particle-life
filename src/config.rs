...
pub static GAME_AREA_SIZE_U: Vec2 = Vec2::from_array([8000., 8000.]); // Might act weird when this is not square
...
pub static mut ATTRACT_CONSTANT: f32 = 0.05;
pub static NUM_PARTICLES: usize = 100_000;
